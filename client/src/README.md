...
Tokens are used to identify and authorize a user.

- [ ] What steps can you take in your web apps to keep your data secure?

Use tokens to match username/password/other fields user inputs to encrypted data.

- [ ] Describe how web servers work.

They store programs and data.
